...
in
{
  ...
  wayland.windowManager.hyprland = {
    ...
    settings = {
      ...
      on = call [
        ...
        (lua ''
          function()
            hl.exec_cmd('${caelestia-cli} shell -d')
            hl.exec_cmd('${caelestia-cli} scheme -n dynamic')
  ...
  wayland.windowManager.hyprland.settings.gesture = call [
    {
      fingers = 3;
      direction = "vertical";
      action = "workspace";
  ...
  wayland.windowManager.hyprland.settings.bind = map call (
    [
      [
        "SUPER + RETURN"
      ...
      [
        "SUPER + SPACE"
        (lua "hl.dsp.exec_cmd('${caelestia-cli} shell drawers toggle launcher')")
      ]
      [
        "SUPER + O"
        (lua "hl.dsp.exec_cmd('${caelestia-cli} shell drawers toggle dashboard')")
      ]
      [
        "SUPER + Q"
